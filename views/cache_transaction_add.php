...
<div class="row">
  <div class="col-lg-12">
{{$operation}}
    <form action="/transaction/{{ (htmlentities($operation)) }}" method="post">
      ...
      <div class="form-group">
        ...
        <textarea class="form-control" id="message" name="message" placeholder="Say thank you, or some other note." rows="12">{{ (htmlentities($transaction['message'])) }}</textarea>
      </div>
      <div class="form-group">
