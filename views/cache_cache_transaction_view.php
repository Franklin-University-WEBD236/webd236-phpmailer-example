...
<div class="row">
  <div class="col-lg-12">
    <p>$<?php echo(htmlentities( abs($transaction['amount']))); ?> was sent on: <?php echo(htmlentities($transaction['date'])); ?></p>
  </div>
</div>

<div class="row">
  <div class="col-lg-12">
    <p>From: <?php echo(htmlentities( $transaction['sender'])); ?> => To: <?php echo(htmlentities( $transaction['receiver'])); ?></p>
  </div>
</div>

<div class="row">
  <div class="col-lg-12">
    <h4><?php echo(htmlentities( $transaction['subject'])); ?></h4>
  </div>
</div>
